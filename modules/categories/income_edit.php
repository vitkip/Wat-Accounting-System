...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $stmt = $db->prepare("UPDATE income_categories SET name = ?, description = ? WHERE id = ?");
            
            if ($stmt->execute([$name, $description, $id])) {
                logActivity($_SESSION['user_id'], 'UPDATE', 'income_categories', $id, "ແກ້ໄຂໝວດໝູ່ລາຍຮັບ: {$name}");
            ...
            <form method="POST" class="space-y-6">
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h3 class="text-blue-800 font-medium">ສະຖິຕິການໃຊ້ງານ</h3>
