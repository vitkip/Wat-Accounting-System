...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!checkCSRF()) {
        ...
        header('Location: ' . BASE_URL . '/modules/income/edit.php?id=' . $id);
        exit();
    }
    ...
    if (empty($errors)) {
        try {
            ...
            // ບັນທຶກ audit log
            logAudit($_SESSION['user_id'], 'UPDATE', 'income', $id, $record, [
                'date' => $date,
                'description' => $description,
                'amount' => $amount,
                'category' => $category
            ...
            setFlashMessage('ແກ້ໄຂລາຍຮັບສຳເລັດແລ້ວ ✓', 'success');
            header('Location: ' . BASE_URL . '/modules/income/list.php');
            exit();
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 mb-2">ແກ້ໄຂລາຍຮັບ</h1>
                <p class="text-gray-600">ແກ້ໄຂຂໍ້ມູນລາຍຮັບ</p>
            </div>
        ...
        <form method="POST" action="">
            ...
            <div class="mb-6">
                ...
                <textarea id="description" 
                          ...
                          rows="4"
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                          placeholder="ລາຍລະອຽດລາຍຮັບ..."><?php echo e($_POST['description'] ?? $record['description']); ?></textarea>
            </div>
